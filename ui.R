...
ui <- dashboardPage(
  ...
  dashboardSidebar(width = 350,
              ...
              sidebarMenu(
                menuItem('View Raw Expression Data', tabName = 'voom', icon = icon('hand-o-right')),
                  ...
                  menuItem('GSEA Using Camera', tabName = 'camera', icon = icon('hand-o-right')),
                  menuItem('Pathway Analysis using SPIA', tabName = 'spia', icon = icon('hand-o-right')),
                  menuItem('GO Analysis uisng GAGE', tabName = 'gogage', icon = icon('hand-o-right'))
)#end of sidebar menu
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      #tabItem(tabName = "spia",DT::dataTableOutput('table_TRUE')),
      
      #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
      #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
      #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
      #tabItem(tabName = "gogage",DT::dataTableOutput('table_TRUE'))
    )
  )
)
